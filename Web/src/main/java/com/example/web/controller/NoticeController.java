...
public class NoticeController {
    ...
    private static Notice init(int id,String title,String content){
        Notice notice=new Notice();
        notice.setId(id);
        notice.setContent(content);
        notice.setTitle(title);
    ...
    private static Notice init(int id){
        Notice notice=new Notice();
        notice.setId(id);
        return notice;
    }
    ...
    public Result edit(int id,String title,String content){
        noticeMapper.editbyid(init(id,title,content));
